...
type DB struct {
	...
	// reindexAuditMu guards reindexAuditLookup/Logger so the deps
	// installed by [DB.SetReindexAuditDeps] are visible from any
	...
	reindexAuditLookup KnownReindexTaskLookup
